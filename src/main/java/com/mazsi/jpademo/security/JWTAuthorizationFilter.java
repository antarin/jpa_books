...
import static com.mazsi.jpademo.security.SecurityConstants.*;
...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req,
        ...
        UsernamePasswordAuthenticationToken authentication = getAthentication(req);
    ...
    private UsernamePasswordAuthenticationToken getAthentication(HttpServletRequest req) {
        String user = SecurityUtils.getUsername(req);
